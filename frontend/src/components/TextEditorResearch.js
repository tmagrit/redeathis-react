...
import { researchContentStyle, researchStyleFormats } from '../styles/textEditorStyles'

const tinyMceKey = process.env.REACT_APP_TINYMCE_API_KEY

const TextEditorResearch = ({ value, setValue, readOnly }) => {
      ...
      <Editor
        ...
        init={{
          ...
          toolbar: 'undo redo | styles | bold italic underline strikethrough | ' +
                   ...
                   'outdent indent | link',
          content_style: researchContentStyle,
          style_formats: researchStyleFormats,
          branding: false,
...
export default TextEditorResearch;