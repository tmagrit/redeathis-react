...
import { institutionalContentStyle, institutionalStyleFormats } from '../styles/textEditorStyles'

const tinyMceKey = process.env.REACT_APP_TINYMCE_API_KEY

const TextEditorInstitutional = ({ value, setValue, readOnly, pageId }) => {
      ...
      <Editor
        ...
        init={{
          ...
          toolbar: 'undo redo | styles | bold italic underline strikethrough | ' +
                   ...
                   'outdent indent | link',
          content_style: institutionalContentStyle,
          style_formats: institutionalStyleFormats,
          branding: false,
...
export default TextEditorInstitutional;