...
import { contributeContentStyle, contributeStyleFormats } from '../styles/textEditorStyles'

const tinyMceKey = process.env.REACT_APP_TINYMCE_API_KEY

const TextEditorContribute = ({ value, setValue, readOnly }) => {
      ...
      <Editor
        ...
        init={{
          ...
          toolbar: 'undo redo | styles | bold italic underline strikethrough | ' +
                   ...
                   'outdent indent | link',
          content_style: contributeContentStyle,
          style_formats: contributeStyleFormats,
          branding: false,
...
export default TextEditorContribute;